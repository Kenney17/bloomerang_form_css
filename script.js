var insertForm2298880 = function() {
    var html2298880 = '<style text=\'text/css\'>' + 
...
'' +  '';var successHtml2298880 = '\u003cscript\u003ewindow.location.replace(\'https://www.familypromiseofspokane.org\')\u003c/script\u003e';( function($) {if (Bloomerang.useDonationId('2298880')) { 
                                ...
                                };if (jQuery('#bloomerangForm2298880').length) {
                    
                if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                    html2298880 = '<p style="color: red">​Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade ​your browser or download the latest version of' + 
                    ...
                    jQuery('#bloomerangForm2298880').after(html2298880);
                                        ...
                                        Bloomerang.Util.load('https://core.spreedly.com/iframe/express-2.min.js', 
                                            ...
                                            function() {
                                                ...
                                                Bloomerang.initSpreedly = function() {
                                                    SpreedlyExpress.init('OqOMv1ksjPtXEYHtCYsVXzEpCbR', { 'company_name': 'Family Promise of Spokane' });
                                                };
                     ...
                     Bloomerang.Util.requireStripe(function() {
                                    Bloomerang.Util.Stripe = Stripe('pk_live_51BWBOGGK86snBCPRNawVeT8SipaJNq50MNiLDGpDSH9xnAqpmo6V4jdoP0XLtl6u5vP9m5AJqX4w5lFQjKVJFnNq00DSRlMXh7'); 
                   ...
                   window.captchaLoadCallback = function() {
                    ...
                    Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                        ...
                        function() {
                            ...
                            jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha2298880', { 'sitekey' : '6LcN8NwZAAAAAKSu3Vyl4mo9rxLGMqZnbbkI6LFb' }));
                        },
                        true,
                        true);
          ...
          jQuery(e).toggle();
            ...
            var startBloomerangLoad = function() {
                if (window.bloomerangLoadStarted == undefined) {
                    ...
                    waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm2298880(); })});
                }
                else {
                    waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm2298880(); })});
                }
